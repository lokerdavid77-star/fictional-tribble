-- =================================================================
--  vozoid ui  --  single file, no external deps
    ...
    function win:Tab(name)
        ...
        function tab:Section(sectionName, side)
            ...
            function sec:Toggle(o)
                ...
                local swatch
                if o.Color then
                    swatch = new("TextButton", {
                        Text = "", Size = UDim2.fromOffset(20, 12),
                        Position = UDim2.new(1, -20, 0.5, -6),
                        BackgroundColor3 = o.Color, BorderSizePixel = 0,
                        ZIndex = 9, Parent = row,
                    })
                    corner(swatch, 2); stroke(swatch, T.Stroke)
                end
                ...
                if swatch and o.ColorCallback then
                    swatch.MouseButton1Click:Connect(function()
                        openColorPicker(swatch, swatch.BackgroundColor3, function(c)
                            swatch.BackgroundColor3 = c
                            fire(o.ColorCallback, c)
                        end)
                    end)
                end
